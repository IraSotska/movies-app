...
//        List<Movie> result = (List<Movie>) movieService.findAll(List.of(new SortType(SortField.RATING, SortDirection.DESK)));
//
...
//        movieService.setMovieDao(movieDao);
//
//        List<Movie> result = (List<Movie>) movieService.findAll(List.of(new SortType(SortField.PRICE, SortDirection.ACS)));
//
//        assertNotNull(result);
...
//        MovieServiceImpl movieService = new MovieServiceImpl();
//        movieService.setMovieDao(movieDao);
//        List<Movie> result = (List<Movie>) movieService.findAll(List.of(new SortType(SortField.RATING, SortDirection.ACS)));
//
//        assertNotNull(result);
//        assertEquals(movie1, result.get(0));
//        assertEquals(movie2, result.get(1));
...
//        MovieServiceImpl movieService = new MovieServiceImpl();
//        movieService.setMovieDao(movieDao);
//        List<Movie> result = (List<Movie>) movieService.findAll(List.of(new SortType(SortField.PRICE, SortDirection.ACS), new SortType(SortField.RATING, SortDirection.ACS)));
//
//        assertNotNull(result);
//        assertEquals(movie3, result.get(0));
